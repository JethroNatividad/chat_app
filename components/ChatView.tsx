	...
	return (
		<div className="h-full w-full bg-primary-dark flex flex-col">
			...
			<div className="h-16 w-full shadow-md flex items-center px-5 justify-between">
				<div className="flex items-center space-x-5 md:space-x-0">
					<div
						...
						onClick={() => setOpenChatGroupId(null)}
					>
			...
			<div className="h-16 px-5 flex items-center">
				<form
					className="bg-gray-500 h-2/3 shadow-lg w-full rounded-lg overflow-hidden flex px-2 items-center"
					onSubmit={handleSendMessage}
				>
					<input
						value={input}
						onChange={handleInputChange}
						className="w-full h-full outline-none bg-inherit text-white placeholder:text-white"
						type="text"
